...
class Bank_Client{   // THIS POINTER 
    private:
    ...
    void set_credit_card_number(int number) {
            ...
            // The pointer to the object is inherently passed by pointer called "this" 
            cout<<"The addredd of the object calling this function is "<<this;
        }
...
int main(){
    ...
    // In this function, other than the paramenters of the function, we also pass the pointer of the objects of this call, and the pointer is reffered to by "this"
